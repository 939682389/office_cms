...
public class UpdateService extends JPanel implements ActionListener{
    ...
    public UpdateService(){
        ...
        box1.add(new JLabel("服务号:",JLabel.CENTER));
        box1.add(卡号);
        box2.add(new JLabel("金额:",JLabel.CENTER));
        box2.add(姓名);
        box3.add(修改);
        box5.add(new JLabel("服务名称:",JLabel.CENTER));
        box5.add(卡号1);
        box5.add(查找);
        修改.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                try {
                    ...
                    if(DBUtil.update_service(卡号.getText(), 姓名.getText()))
                    {
        ...
        查找.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                try {
                    Map<String, String> res = DBUtil.query_service_by_name(卡号1.getText());
                    if(!res.isEmpty())
                    {
